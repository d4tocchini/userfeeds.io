...
$(document).ready(function(){toggleFromURLHash();$(".price-toggle").click(function(){var currency=$(this).data('currency');renderCurrency(currency);});});